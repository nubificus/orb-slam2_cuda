...
#undef GET_VALUE
            ...
            iniThFAST(_iniThFAST), minThFAST(_minThFAST)
    {
        ...
        cudaStreamCreate(&cudaStreamCpy);
        cudaStreamCreate(&cudaStreamBlur);
        ...
        cudaMallocHost(&corner_size, sizeof(uint)*nlevels);
    ...
    vector<OrbKeyPoint> ORBextractor::DistributeOctTree(const vector<OrbKeyPoint>& vToDistributeKeys, const int &minX,
    ...
    void ORBextractor::allocMemory(int w, int h, int imageStep) {
        ...
        // cudaMallocHost(&(this->score), sizeof(int)*w*h*this->nlevels);
                                  ...
                                  OutputArray _descriptors, std::vector<int> &vLappingArea)
    {
        ...
        // double time = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(time_End - time_Start).count();
