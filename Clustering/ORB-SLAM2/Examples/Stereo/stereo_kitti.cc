...
double calcDeviation(vector<float> v_times, double average)
{
    double accum = 0;
...
int main(int argc, char **argv)
{
    ...
    double deviation = calcDeviation(vTimesTrack, totaltime/nImages);
    cout << "-------" << endl << endl;
    cout << "median tracking time: " << vTimesTrack[nImages/2] << endl;
    cout << "mean tracking time: " << totaltime/nImages << endl;
    cout << "std tracking time: " << deviation << endl;
